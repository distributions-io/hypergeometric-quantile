...
describe( 'partial quantile', function tests() {
	...
	it( 'should partially apply the quantile function of the hypergeometric distribution for given parameter values', function test() {
		var quantile;
		quantile = partial( m, n, k );
